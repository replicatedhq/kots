...
test("smoke test", async ({ page }) => {
  ...
  await expect(page.locator("#app")).toContainText("Results", { timeout: 60 * 1000 });
  ...
  await page.getByTestId("navbar-dropdown-container").getByTestId("navbar-dropdown-button").click();
  await page.getByTestId("navbar-dropdown-container").getByTestId("log-out").click();
