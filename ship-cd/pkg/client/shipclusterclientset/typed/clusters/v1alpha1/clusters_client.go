...
// ClustersV1alpha1Client is used to interact with features provided by the clusters.replicated.com group.
type ClustersV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ClustersV1alpha1Client) Clusters(namespace string) ClusterInterface {
