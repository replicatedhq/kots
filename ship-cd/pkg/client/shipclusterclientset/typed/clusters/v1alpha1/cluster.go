...
import (
	...
	scheme "github.com/replicatedhq/ship-cluster/ship-cd/pkg/client/shipclusterclientset/scheme"
...
func newClusters(c *ClustersV1alpha1Client, namespace string) *clusters {
	return &clusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
