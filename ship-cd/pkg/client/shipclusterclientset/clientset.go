...
package shipclusterclientset

import (
	clustersv1alpha1 "github.com/replicatedhq/ship-cluster/ship-cd/pkg/client/shipclusterclientset/typed/clusters/v1alpha1"
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.clustersV1alpha1, err = clustersv1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.clustersV1alpha1 = clustersv1alpha1.NewForConfigOrDie(c)
