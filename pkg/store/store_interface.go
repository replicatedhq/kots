...
type DownstreamStore interface {
	...
	GetDownstreamVersionHistory(appID string, clusterID string, currentPage int, pageSize int, pinLatest bool, pinLatestDeployable bool) ([]*downstreamtypes.DownstreamVersion, error)
