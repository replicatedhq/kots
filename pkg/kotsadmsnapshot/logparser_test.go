...
const (
	basicLogs = `time="2020-08-24T15:41:00Z" level=info msg="Setting up backup temp file" backup=velero/qakots-ns24s logSource="pkg/controller/backup_controller.go:494"
