			...
			want: []types.AvailableUpdate{
				{
					...
					ReleaseNotes:       "release notes",
					IsDeployable:       false,
					NonDeployableCause: "This version cannot be deployed because it would downgrade the infrastructure, which is unsupported.",
				},
			},
		},
		{
			...
			want: []types.AvailableUpdate{
				{
					...
					ReleaseNotes:       "release notes",
					IsDeployable:       false,
					NonDeployableCause: "This version cannot be deployed because the required infrastructure compatibility could not be verified.",
				},
			},
		},
		{
