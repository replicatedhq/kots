		...
		},
		{
			...
			want: []types.AvailableUpdate{
				...
				},
				{
					...
					ReleaseNotes:       "release notes",
					IsDeployable:       false,
					NonDeployableCause: "This version cannot be deployed because of incompatible kubernetes versions, cannot update by more than one kubernetes minor version: current 1.30.0, update 1.32.0. Update to the most recent deployable version 0.0.1.",
				},
				{
					VersionLabel:       "0.0.1",
					UpdateCursor:       "1",
			...
			want: []types.AvailableUpdate{
				{
					...
					ReleaseNotes:       "release notes",
					IsDeployable:       false,
					NonDeployableCause: "This version cannot be deployed because of incompatible kubernetes versions, cannot update by more than one kubernetes minor version: current 1.30.0, update 1.32.0.",
				},
			},
		},
		{
			...
			want: []types.AvailableUpdate{
				{
					...
					ReleaseNotes:       "release notes",
					IsDeployable:       false,
					NonDeployableCause: "This version cannot be deployed because of incompatible kubernetes versions, cannot downgrade the kubernetes version: current 1.30.0, update 1.29.0.",
				},
			},
		},
		{
			...
			want: []types.AvailableUpdate{
				{
					...
					ReleaseNotes:       "release notes 4",
					IsDeployable:       false,
					NonDeployableCause: "This version cannot be deployed because of incompatible kubernetes versions, cannot update by more than one kubernetes minor version: current 1.30.0, update 1.32.0. Update to the most recent deployable version 1.0.3.",
				},
				{
					VersionLabel:       "1.0.3",
					UpdateCursor:       "3",
			...
			want: []types.AvailableUpdate{
				{
					...
					ReleaseNotes:       "release notes",
					IsDeployable:       false,
					NonDeployableCause: "This version cannot be deployed because of incompatible kubernetes versions, failed to extract update kube version: failed to extract kube version from '2.5.0-invalid-format'.",
				},
			},
		},
		{
