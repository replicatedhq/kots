...
func (o *Operator) reconcileDeployment(cm *corev1.ConfigMap) (finalError error) {
	...
	if targetECVersion != currentECVersion {
		logger.Infof("EC version changing from %s to %s - waiting for cluster upgrade", currentECVersion, targetECVersion)
...
func (o *Operator) notifyClusterUpgradeSucceeded(ctx context.Context, kbClient kbclient.Client, ins *embeddedclusterv1beta1.Installation, appID string) error {
	...
	err = embeddedcluster.NotifyUpgradeSucceeded(ctx, util.ReplicatedAppEndpoint(license), ins, prev)
	if err != nil {
...
func (o *Operator) notifyClusterUpgradeFailed(ctx context.Context, kbClient kbclient.Client, ins *embeddedclusterv1beta1.Installation, appID string) error {
	...
	err = embeddedcluster.NotifyUpgradeFailed(ctx, util.ReplicatedAppEndpoint(license), ins, prev, ins.Status.Reason)
	if err != nil {
		return errors.Wrap(err, "failed to send event")
	}
	return nil
