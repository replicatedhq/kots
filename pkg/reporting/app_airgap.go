		...
		Events: []InstanceReportEvent{
			{
				...
				SnapshotFullSchedule:      reportingInfo.SnapshotFullSchedule,
				SnapshotFullTTL:           reportingInfo.SnapshotFullTTL,
				SnapshotPartialSchedule:   reportingInfo.SnapshotPartialSchedule,
				SnapshotPartialTTL:        reportingInfo.SnapshotPartialTTL,
