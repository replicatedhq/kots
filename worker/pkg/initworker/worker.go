...
func (w *Worker) Run(ctx context.Context) error {
	logger := log.With(w.Logger, "method", "initworker.Worker.Execute")
...
func (w *Worker) ensureNamespace(ctx context.Context, namespace *corev1.Namespace) error {
	debug := level.Debug(log.With(w.Logger, "method", "initworker.Worker.ensureNamespace"))
...
func (w *Worker) ensureSecret(ctx context.Context, secret *corev1.Secret) error {
	debug := level.Debug(log.With(w.Logger, "method", "initworker.Worker.ensureSecret"))
...
func (w *Worker) ensurePod(ctx context.Context, pod *corev1.Pod) error {
	debug := level.Debug(log.With(w.Logger, "method", "initworker.Worker.ensurePod"))
...
func (w *Worker) ensureService(ctx context.Context, service *corev1.Service) error {
	debug := level.Debug(log.With(w.Logger, "method", "initworker.Worker.ensureService"))
...
func (w *Worker) ensureRole(todo context.Context, role *v1.Role) interface{} {
	debug := level.Debug(log.With(w.Logger, "method", "initworker.Worker.ensureRole"))
...
func (w *Worker) ensureRoleBinding(todo context.Context, roleBinding *v1.RoleBinding) interface{} {
	debug := level.Debug(log.With(w.Logger, "method", "initworker.Worker.ensureRoleBinding"))
