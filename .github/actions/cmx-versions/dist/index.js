...
/* harmony import */ var semver_functions_coerce_js__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(3466);
/* harmony import */ var semver_functions_major_js__WEBPACK_IMPORTED_MODULE_3__ = __nccwpck_require__(6688);
/* harmony import */ var semver_functions_minor_js__WEBPACK_IMPORTED_MODULE_4__ = __nccwpck_require__(8447);
/* harmony import */ var semver_functions_gt_js__WEBPACK_IMPORTED_MODULE_5__ = __nccwpck_require__(4123);
/* harmony import */ var semver_functions_rsort_js__WEBPACK_IMPORTED_MODULE_6__ = __nccwpck_require__(8701);
  ...
  async function getClusterVersions() {
    ...
    const apiToken = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('replicated-api-token') || process.env.REPLICATED_API_TOKEN;
    const headers = {
    ...
    let clusterVersions = [];
    try {
      const response = await node_fetch__WEBPACK_IMPORTED_MODULE_1__(url, {
        method: 'GET',
        headers,
      });
    ...
    _actions_core__WEBPACK_IMPORTED_MODULE_0__.setOutput('versions-to-test', JSON.stringify(versionsToTest));
  }
  ...
  function getLatestVersion(distribution) {
    ...
    distribution.versions.forEach((version) => {
      if (latestVersion === undefined) {
        ...
        const parsed = semver_functions_coerce_js__WEBPACK_IMPORTED_MODULE_2__(version);
        if (semver_functions_gt_js__WEBPACK_IMPORTED_MODULE_5__(parsed, semver_functions_coerce_js__WEBPACK_IMPORTED_MODULE_2__(latestVersion))) {
          latestVersion = version;
        }
      }
    });
  ...
  function getLastMajorMinorVersions(distribution, numOfLatestMajorMinorVersions) {
    ...
    distribution.versions.forEach((version) => {
      const parsed = semver_functions_coerce_js__WEBPACK_IMPORTED_MODULE_2__(version);
      latestMajorMinorVersions.push(`${semver_functions_major_js__WEBPACK_IMPORTED_MODULE_3__(parsed)}.${semver_functions_minor_js__WEBPACK_IMPORTED_MODULE_4__(parsed)}`);
    });
  ...
  function sortVersions(latestMajorMinorVersions) {
    ...
    latestMajorMinorVersions = semver_functions_rsort_js__WEBPACK_IMPORTED_MODULE_6__(latestMajorMinorVersions);
  ...
  function getLatestMinorVersions(distribution, majorMinorVersionFilter) {
    ...
    distribution.versions.forEach((version) => {
      ...
      const majorMinor = `${semver_functions_major_js__WEBPACK_IMPORTED_MODULE_3__(parsed)}.${semver_functions_minor_js__WEBPACK_IMPORTED_MODULE_4__(parsed)}`;
      if (!majorMinorVersionFilter?.length || majorMinorVersionFilter.includes(majorMinor)) {
        if (latestMinorVersions[majorMinor] === undefined) {
          ...
          if (semver_functions_gt_js__WEBPACK_IMPORTED_MODULE_5__(parsed, semver_functions_coerce_js__WEBPACK_IMPORTED_MODULE_2__(currentVersion))) {
            latestMinorVersions[majorMinor] = version;
          }
        }
      }
