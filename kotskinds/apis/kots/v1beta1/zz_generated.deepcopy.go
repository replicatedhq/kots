...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StorageConfigSource) DeepCopyInto(out *StorageConfigSource) {
	*out = *in
	if in.SecretKeyRef != nil {
		in, out := &in.SecretKeyRef, &out.SecretKeyRef
		*out = new(v1.SecretKeySelector)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StorageConfigSource.
func (in *StorageConfigSource) DeepCopy() *StorageConfigSource {
	if in == nil {
		return nil
	}
	out := new(StorageConfigSource)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StorageConfigValue) DeepCopyInto(out *StorageConfigValue) {
	*out = *in
	if in.Value != nil {
		in, out := &in.Value, &out.Value
		*out = new(StorageConfig)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StorageConfigValue.
func (in *StorageConfigValue) DeepCopy() *StorageConfigValue {
	if in == nil {
		return nil
	}
	out := new(StorageConfigValue)
