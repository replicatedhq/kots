...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConfigValueSpec) DeepCopyInto(out *ConfigValueSpec) {
	*out = *in
	if in.Values != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigValueSpec.
func (in *ConfigValueSpec) DeepCopy() *ConfigValueSpec {
	if in == nil {
		return nil
	}
	out := new(ConfigValueSpec)
	in.DeepCopyInto(out)
	return out
}
