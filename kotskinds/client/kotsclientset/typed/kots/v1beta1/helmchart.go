...
func (c *helmCharts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.HelmChart, err error) {
...
func (c *helmCharts) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.HelmChartList, err error) {
...
func (c *helmCharts) Create(ctx context.Context, helmChart *v1beta1.HelmChart, opts v1.CreateOptions) (result *v1beta1.HelmChart, err error) {
	result = &v1beta1.HelmChart{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("helmcharts").
...
func (c *helmCharts) Update(ctx context.Context, helmChart *v1beta1.HelmChart, opts v1.UpdateOptions) (result *v1beta1.HelmChart, err error) {
	result = &v1beta1.HelmChart{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("helmcharts").
...
func (c *helmCharts) UpdateStatus(ctx context.Context, helmChart *v1beta1.HelmChart, opts v1.UpdateOptions) (result *v1beta1.HelmChart, err error) {
	result = &v1beta1.HelmChart{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("helmcharts").
...
func (c *helmCharts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.HelmChart, err error) {
	result = &v1beta1.HelmChart{}
