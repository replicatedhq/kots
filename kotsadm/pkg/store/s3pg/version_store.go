...
func (c S3PGStore) GetClientset() (*kubernetes.Clientset, error) {
...
func (s S3PGStore) getConfigmap(name string) (*corev1.ConfigMap, error) {
...
func (s S3PGStore) createAppVersion(tx *sql.Tx, appID string, currentSequence *int64, filesInDir string, source string, skipPreflights bool, gitops gitopstypes.DownstreamGitOps) (int64, error) {
	...
	for _, d := range downstreams {
		...
		metadataConfigMap, err := s.getConfigmap("kotsadm-application-metadata")
		if err != nil {
