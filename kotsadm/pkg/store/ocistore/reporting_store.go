...
func (s OCIStore) getClusterID() (string, error) {
...
func (s OCIStore) getDownstreamInfo(appID string) (*downstreamInfo, error) {
	di := downstreamInfo{}
...
func (s OCIStore) getK8sVersion() (string, error) {
