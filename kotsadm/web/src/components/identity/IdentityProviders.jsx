...
class IdentityProviders extends Component {
  ...
  render() {
    ...
    const { isKurlEnabled, isApplicationSettings, appName } = this.props;
    ...
    return (
      <div className="flex-column flex1 u-position--relative u-overflow--auto u-padding--20 alignItems--center">
        ...
        <form className="flex flex-column Identity--wrapper u-marginTop--30">
          <p className="u-fontSize--largest u-lineHeight--default u-fontWeight--bold u-color--tuna"> Configure Identity Provider {isApplicationSettings && `for ${appName}`}</p>
