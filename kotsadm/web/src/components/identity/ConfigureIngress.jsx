...
class ConfigureIngress extends Component {
  ...
  render() {
    ...
    for (let i = 0; i < this.state.annotationRowsNum; ++i) {
      annotationRows.push(<AnnotationRow key={i} number={i} removeAnnotation={this.removeAnnotation} />);
    };
          ...
          <div className="BoxedCheckbox-wrapper flex1 u-textAlign--left u-marginTop--20">
            <div className={`flex-auto flex ${this.state.ingressEnabled ? "is-active" : ""}`}>
              <input
                ...
                onChange={(e) => { this.handleFormChange("ingressEnabled", e) }}
              />
          ...
          {this.state.ingressEnabled &&
            <div className="flex flex-column">
              ...
              <div className="u-marginTop--30">
                    ...
                    <div className="flex flex1">
                      ...
                      {hasFile ?
                        <div className="has-file-wrapper">
                          <p className="u-fontSize--normal u-fontWeight--medium">{certFile?.name}</p>
                        </div>
                        :
                ...
                <p className="u-fontSize--normal u-lineHeight--normal u-fontWeight--medium u-marginTop--5"> Optionally you can reference the TLS secret deployed to your Cluster. </p>
                <input type="text"
                  className="Input u-marginTop--12"
                  placeholder="secretName"
                  value={this.state.secretName}
                  onChange={(e) => { this.handleFormChange("secretName", e) }} />
              </div>
