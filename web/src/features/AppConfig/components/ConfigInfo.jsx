  ...
  if (size(pendingVersions) > 0 && currentSequence === sequence) {
    return (
      <div className="ConfigInfo current justifyContent--center">
        <p className="flex alignItems--center u-marginRight--5" data-testid="config-info-current">
    ...
    return (
      <div className="ConfigInfo newer justifyContent--center" data-testid="config-info-newer">
        <p className="flex alignItems--center u-marginRight--5">
