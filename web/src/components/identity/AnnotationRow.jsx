...
export default class AnnotationRow extends Component {
  ...
  render() {
    return (
      <div className="flex flex-column u-borderBottom--gray darker" style={{ padding: "8px 10px" }}>
          ...
          <div className="flex justifyContent--flexStart">
            ...
            <div className="flex alignItems--center u-marginLeft--20">
              ...
              <input type="text"
                ...
                onChange={(e) => { this.handleFormChange("value", e) }} />
            </div>
          </div>
          <div className="flex fle1 justifyContent--flexEnd">
            <span className="icon gray-trash u-cursor--pointer" onClick={this.props.removeAnnotation} />
          </div>
        </div>
      </div>
    )
