      ...
      <div className="flex-column flex1 u-position--relative u-overflow--auto u-padding--20 alignItems--center">
        ...
        <form className="flex-auto Identity--wrapper u-marginTop--30">
          <div className="flex1 flex-column">
            <p className="u-fontSize--largest u-lineHeight--default u-fontWeight--bold u-textColor--primary"> Configure Identity Provider {isApplicationSettings && `for ${app?.name}`}</p>
            <p className="u-fontSize--normal u-lineHeight--medium u-fontWeight--medium u-textColor--bodyCopy u-marginTop--12"> Configure additional OIDC providers to authenticate in to the Admin Console. </p>
                ...
                <div className={`flex-auto flex ${syncAppWithGlobal ? "is-active" : ""}`}>
                  ...
                  <label htmlFor="syncAppWithGlobal" className="flex1 flex u-width--full u-position--relative u-cursor--pointer u-userSelect--none" style={{ marginTop: "2px" }}>
                    <div className="flex flex-column u-marginLeft--5 justifyContent--center">
                      <p className="u-textColor--primary u-fontSize--normal u-fontWeight--medium">Use Admin Console settings</p>
              ...
              <div className="flex1 flex-column">
                <div className="u-marginTop--30">
                  <div className="flex flex1 alignItems--center">
                    <p className="u-fontSize--large u-lineHeight--default u-fontWeight--bold u-textColor--primary"> {isApplicationSettings ? "App" : "Admin Console"} URL </p>
                    <span className="required-label"> Required </span>
                    {requiredErrors?.adminConsoleAddress && <span className="u-textColor--error u-fontSize--small u-fontWeight--medium u-lineHeight--normal u-marginLeft--5"> Admin Console URL is a required field </span>}
                  </div>
                  <p className="u-fontSize--normal u-lineHeight--medium u-fontWeight--medium u-textColor--bodyCopy u-marginTop--12"> The URL for accessing the KOTS Admin Console. This URL must be accessible from both the browser as well as the KOTS service. </p>
                  <input type="text"
                ...
                {!isKurlEnabled && (
                  <div className="u-marginTop--30">
                    <div className="flex flex1 alignItems--center">
                      <p className="u-fontSize--large u-lineHeight--default u-fontWeight--bold u-textColor--primary"> ID Address </p>
                      <span className="required-label"> Required </span>
                      {requiredErrors?.identityServiceAddress && <span className="u-textColor--error u-fontSize--small u-fontWeight--medium u-lineHeight--normal u-marginLeft--5"> ID address is a required field </span>}
                    </div>
            ...
            <div className="flex1 flex-column u-marginTop--30">
              <p className="u-fontSize--large u-lineHeight--default u-fontWeight--bold u-textColor--primary"> Select an Identity Provider </p>
            ...
            <div className="IdentityProvider--info u-marginTop--30 flex1 flex-column">
              <div className="flex flex1">
                {selectedProvider === "oidcConfig" &&
                  <div className="flex1 flex-column u-marginRight--20">
                    <div className="flex flex1 alignItems--center u-marginBottom--5">
                      <p className="u-fontSize--large u-lineHeight--default u-fontWeight--bold u-textColor--primary"> Connector  name </p>
                      <span className="required-label"> Required </span>
                    </div>
                    {requiredErrors?.connectorName && <span className="u-textColor--error u-fontSize--small u-fontWeight--medium u-lineHeight--normal"> Connector name is a required field</span>}
                    <input type="text"
                      className="Input u-marginTop--12"
                      placeholder="OpenID"
                      disabled={syncAppWithGlobal}
                ...
                <div className="flex1 flex-column">
                  <div className="flex flex1 alignItems--center u-marginBottom--5">
                    <p className="u-fontSize--large u-lineHeight--default u-fontWeight--bold u-textColor--primary"> Issuer </p>
                  ...
                  {requiredErrors?.issuer && <span className="u-textColor--error u-fontSize--small u-fontWeight--medium u-lineHeight--normal"> Issuer is a required field </span>}
                  <input type="text"
                    className="Input u-marginTop--12"
                    disabled={syncAppWithGlobal}
              ...
              <div className="flex flex1 u-marginTop--30">
                <div className="flex1 flex-column u-marginRight--20">
                  <div className="flex flex1 alignItems--center u-marginBottom--5">
                    <p className="u-fontSize--large u-lineHeight--default u-fontWeight--bold u-textColor--primary"> Client ID </p>
                    <span className="required-label"> Required </span>
                  </div>
                  {requiredErrors?.clientId && <span className="u-textColor--error u-fontSize--small u-fontWeight--medium u-lineHeight--normal"> Client ID is a required field </span>}
                  <input type="text"
                    className="Input u-marginTop--12"
                ...
                <div className="flex1 flex-column">
                  <div className="flex flex1 alignItems--center u-marginBottom--5">
                    <p className="u-fontSize--large u-lineHeight--default u-fontWeight--bold u-textColor--primary"> Client secret </p>
                    <span className="required-label"> Required </span>
                  </div>
                  {requiredErrors?.clientSecret && <span className="u-textColor--error u-fontSize--small u-fontWeight--medium u-lineHeight--normal"> Client Secret is a required field </span>}
                  <input type="password"
                    className="Input u-marginTop--12"
            ...
            {size(this.state.roles) > 0 &&
              <div className="RbacPolicy--wrapper flex1 flex-column">
                <div className={`u-marginTop--30 ${size(this.state.rbacGroupRows) > 0 && "u-borderBottom--gray darker"}`}>
                  <p className="u-fontSize--large u-lineHeight--default u-fontWeight--bold u-textColor--primary"> Role Based Access Control Group Policy </p>
                  <p className="u-fontSize--normal u-lineHeight--medium u-fontWeight--medium u-textColor--bodyCopy u-marginTop--12 u-marginBottom--10"> Groups are defined by your identity provider as is adding and removing of team members to those groups. </p>
                </div>
                {size(this.state.rbacGroupRows) > 0 ?
                  <div className="flex-1-auto flex-column">
                    ...
                    <p className="u-fontSize--small u-fontWeight--medium u-lineHeight--normal u-linkColor u-cursor--pointer u-marginTop--15" onClick={this.onAddGroupRow}> + Add a group </p>
                  </div> :
            ...
            {this.state.selectedProvider === "oidcConfig" &&
              <div className="flex1 flex-column u-marginTop--20">
                <p className="u-fontSize--small u-fontWeight--medium u-lineHeight--normal u-linkColor u-cursor--pointer" onClick={this.toggleAdvancedOptions}> Advanced options
                  ...
                  <div className="flex flex-column u-marginTop--12">
                    <div className="flex flex1 justifyContent--spaceBetween">
                      <div className="flex flex-column justifyContent--flexStart" style={{ marginRight: "40px" }}>
                        <div className={`flex-auto flex alignItems--center ${this.state.oidcConfig?.getUserInfo ? "is-active" : ""}`}>
                          ...
                          <label htmlFor="getUserInfo" className="flex1 flex u-width--full u-position--relative u-cursor--pointer u-userSelect--none alignItems--center" style={{ marginLeft: "2px" }}>
                            <p className="u-textColor--primary u-fontSize--normal u-fontWeight--medium">Get user info</p>
                            <span className="icon grayOutlineQuestionMark--icon u-marginLeft--10 u-cursor--pointer"
                      ...
                      take priority over claims returned by the IDToken. This option should be used when the IDToken doesn't contain all the claims requested." />
                        ...
                        <div className={`flex-auto flex alignItems--center u-marginTop--20 ${this.state.oidcConfig?.insecureEnableGroups ? "is-active" : ""}`}>
                          ...
                          <label htmlFor="insecureEnableGroups" className="flex1 flex u-width--full u-position--relative u-cursor--pointer u-userSelect--none alignItems--center" style={{ marginLeft: "2px" }}>
                            <p className="u-textColor--primary u-fontSize--normal u-fontWeight--medium">Enable insecure groups</p>
                            <span className="icon grayOutlineQuestionMark--icon u-marginLeft--10 u-cursor--pointer"
                      ...
                      this option to enable groups claims through the oidc connector on a per-connector basis." />
                        ...
                        <div className={`flex-auto flex alignItems--center u-marginTop--20  ${this.state.oidcConfig?.insecureSkipEmailVerified ? "is-active" : ""}`}>
                          ...
                          <label htmlFor="insecureSkipEmailVerified" className="flex1 flex u-width--full u-position--relative u-cursor--pointer u-userSelect--none alignItems--center" style={{ marginLeft: "2px" }}>
                            <p className="u-textColor--primary u-fontSize--normal u-fontWeight--medium">Skip email verification</p>
                            <span className="icon grayOutlineQuestionMark--icon u-marginLeft--10 u-cursor--pointer"
                      ...
                      <div className="IdentityProviderAdvanced--info flex flex1 alignItems--center justifyContent--center">
                        <div className="flex1 flex-column u-marginRight--30">
                          <div className="flex flex1">
                            <p className="u-fontSize--large u-lineHeight--default u-fontWeight--bold u-textColor--primary"> User ID key </p>
                            <span className="icon grayOutlineQuestionMark--icon u-marginLeft--10 u-cursor--pointer"
                        ...
                        <div className="flex1 flex-column">
                          <div className="flex flex1">
                            <p className="u-fontSize--large u-lineHeight--default u-fontWeight--bold u-textColor--primary"> User name key </p>
                            <span className="icon grayOutlineQuestionMark--icon u-marginLeft--10 u-cursor--pointer"
                    ...
                    <div className="IdentityProviderAdvanced--info flex">
                      <div className="flex1 flex-column u-marginTop--30 u-marginRight--30">
                        <div className="flex flex1 alignItems--center">
                          <p className="u-fontSize--large u-lineHeight--default u-fontWeight--bold u-textColor--primary"> Prompt type </p>
                          <span className="icon grayOutlineQuestionMark--icon u-marginLeft--10 u-cursor--pointer"
                      ...
                      <div className="flex1 flex-column u-marginTop--30">
                        <div className="flex flex1 alignItems--center">
                          <p className="u-fontSize--large u-lineHeight--default u-fontWeight--bold u-textColor--primary"> Scopes </p>
                          <span className="icon grayOutlineQuestionMark--icon u-marginLeft--10 u-cursor--pointer"
                    ...
                    <div className="flex1 flex-column u-marginTop--30">
                      <div className="flex flex1 alignItems--center">
                        <p className="u-fontSize--large u-lineHeight--default u-fontWeight--bold u-textColor--primary"> Claim mapping </p>
                        <span className="icon grayOutlineQuestionMark--icon u-marginLeft--10 u-cursor--pointer"
                      ...
                      <div className="IdentityProviderAdvanced--info flex">
                        <div className="flex1 flex-column u-marginRight--30 u-marginTop--20">
                          <p className="u-fontSize--large u-lineHeight--default u-fontWeight--bold u-textColor--primary"> Preferred username key </p>
                          <input type="text"
                            className="Input u-marginTop--12"
                        ...
                        <div className="flex1 flex-column u-marginRight--30 u-marginTop--20">
                          <p className="u-fontSize--large u-lineHeight--default u-fontWeight--bold u-textColor--primary"> Email key </p>
                          <input type="text"
                            className="Input u-marginTop--12"
                            placeholder="email"
                        ...
                        <div className="flex1 flex-column u-marginTop--20">
                          <p className="u-fontSize--large u-lineHeight--default u-fontWeight--bold u-textColor--primary"> Group keys </p>
                          <input type="text"
                            className="Input u-marginTop--12"
                            placeholder="groups"
            ...
            <div className="flex flex-column u-marginTop--40">
              {this.state.savingProviderErrMsg &&
                <div className="u-marginBottom--10 flex alignItems--center">
                  <span className="u-fontSize--small u-fontWeight--medium u-textColor--error">{this.state.savingProviderErrMsg}</span>
                </div>}
              <div className="flex flex1">
