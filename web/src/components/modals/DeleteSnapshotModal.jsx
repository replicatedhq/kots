    ...
    >
      <div className="Modal-body">
        <div className="flex flex-column">
          ...
          {deleteErr ?
            <p className="u-textColor--error u-fontSize--small u-fontWeight--medium u-lineHeight--normal">{deleteErrorMsg}</p>
            : null}
          ...
          <div className="flex flex1 justifyContent--spaceBetween u-marginTop--20">
            <div className="flex flex-column">
              <p className="u-fontSize--normal u-fontWeight--bold u-textColor--primary u-lineHeight--normal">{snapshotToDelete?.name}</p>
              <p className="u-fontSize--normal u-textColor--accent u-fontWeight--bold u-lineHeight--normal u-marginRight--20"><span className="u-fontWeight--normal u-textColor--bodyCopy">Captured on:</span> {Utilities.dateFormat(snapshotToDelete?.startedAt, "MM/DD/YY @ hh:mm a z")}</p>
            </div>
