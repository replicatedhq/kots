    ...
    >
      <div className="Modal-body">
        <div className="flex flex-column">
          <p className="u-fontSize--largest u-fontWeight--bold u-textColor--primary u-lineHeight--normal u-marginBottom--more"> Invalid files in your application </p>
          ...
          <div className="u-marginTop--20">
            <p className="u-fontSize--large u-fontWeight--bold u-textColor--primary u-lineHeight--normal u-borderBottom--gray darker u-paddingBottom--10"> The following files contain errors </p>
