    ...
    >
      <div className="Modal-body">
        <div className="flex flex-column">
          <p className="u-fontSize--largest u-fontWeight--bold u-textColor--primary u-lineHeight--normal u-marginBottom--more"> Restore from backup </p>
          ...
          <div className="flex flex1 justifyContent--spaceBetween u-marginTop--20 SnapshotRow--wrapper">
            <div className="flex flex-column">
              <p className="u-fontSize--normal u-fontWeight--bold u-textColor--primary u-lineHeight--normal">{snapshotToRestore?.name}</p>
              <p className="u-fontSize--normal u-textColor--bodyCopy u-fontWeight--medium u-lineHeight--normal u-marginRight--20">{Utilities.dateFormat(snapshotToRestore?.startedAt, "MMM D YYYY @ hh:mm a z")}</p>
            </div>
            <div className="flex flex1 justifyContent--flexEnd">
              <p className="u-fontSize--normal u-textColor--bodyCopy u-fontWeight--bold u-lineHeight--normal u-marginRight--30 justifyContent--center flex alignItems--center"><span className="icon snapshot-volume-size-icon" /> {snapshotToRestore?.volumeSizeHuman} </p>
              <p className="u-fontSize--normal u-textColor--bodyCopy u-fontWeight--bold u-lineHeight--normal justifyContent--center flex alignItems--center u-marginRight--30"><span className="icon snapshot-volume-icon" /> {snapshotToRestore?.volumeSuccessCount}/{snapshotToRestore?.volumeCount}</p>
              <p className="u-fontSize--normal u-textColor--bodyCopy u-fontWeight--bold u-lineHeight--normal justifyContent--center flex alignItems--center"><span className="icon snapshot-app-icon" /> {includedApps?.length} application{includedApps?.length > 1 && "s"}</p>
            </div>
          </div>
          <p className="u-fontSize--large u-fontWeight--bold u-textColor--primary u-lineHeight--normal u-marginBottom--more u-marginTop--30"> Will this be a full or partial restore? </p>
          <p className="u-fontSize--normal u-fontWeight--normal u-textColor--bodyCopy u-lineHeight--normal">
          ...
          {selectedRestore === "full" ?
            ...
            : includedApps?.length === 1 ?
              <div className="flex flex-column u-marginTop--20">
                ...
                {appSlugMismatch ?
                  <p className="u-textColor--error u-fontSize--small u-fontWeight--medium u-lineHeight--normal u-marginTop--10">The app slug you entered does not match the current app slug</p>
                  : null}
              ...
              :
              <div className="flex flex-column u-marginTop--20">
                <p className="u-fontSize--large u-fontWeight--bold u-textColor--primary u-lineHeight--normal u-marginBottom--more"> Which Application would you like to restore? </p>
                <p className="u-fontSize--normal u-fontWeight--normal u-textColor--bodyCopy u-lineHeight--normal"> You can only restore one application at a time. </p>
