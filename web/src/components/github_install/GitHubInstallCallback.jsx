...
class GitHubInstallCallback extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: true,
      ...
      <div className="container flex-column flex1">
        {this.state.isLoading ?
          <div className="flex-column flex1 u-overflow--auto justifyContent--center alignItems--center">
            ...
            <p className="u-fontSize--large u-fontWeight--bold u-marginTop--normal u-color--tuna">Completing Installation</p>
          </div>
          :
          <div className="flex-column flex1 u-overflow--auto justifyContent--center alignItems--center">
