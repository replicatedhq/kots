    ...
    try {
      ...
      const response = await res.json();
        ...
        const fakeResponse = [
          ...
          "hooks": [
              {
                  ...
                  "namespace": "kotsadm",
                  "phase": "pre",
                  "podName": "kotsadm-5854675464-mx4k2",
                  "containerName": "kotsadm",
                  "command": "[/backup.sh]",
                  "stdout": "",
                  "stderr": "",
                  "startedAt": "2024-12-12T19:02:34Z",
                  "finishedAt": "2024-12-12T19:02:34Z",
                  "errors": null,
                  "warnings": null
              }
          ],
          "volumes": [
              {
                  "name": "instance-g4flb-fpgxn",
                  "podName": "kotsadm-5854675464-mx4k2",
                  "podNamespace": "kotsadm",
                  "podVolumeName": "backup",
                  "sizeBytesHuman": "0B",
                  "doneBytesHuman": "0B",
                  "completionPercent": 0,
                  "timeRemainingSeconds": 0,
                  "startedAt": "2024-12-12T19:02:34Z",
                  "finishedAt": "2024-12-12T19:02:35Z",
                  "phase": "Completed"
              }
          ],
          "errors": [
      ...
      // Assuming the response now contains an array of backupDetails
    const snapshotDetails = fakeResponse;
const {currentSnapshotIndex} = this.state;
  // Get series data for first snapshot
  const series = this.getSeriesDataForSnapshot(snapshotDetails[currentSnapshotIndex]);
