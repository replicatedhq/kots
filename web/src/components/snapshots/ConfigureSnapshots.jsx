            ...
            <div className="flex-column u-marginTop--12">
              <div className="InstallVelero--wrapper flex flex-column">
                ...
                <div className="flex1 flex-column u-marginBottom--30">
                  {isKurlEnabled ?
                    <p className="u-fontSize--small flex-auto alignItems--center u-fontWeight--medium u-textColor--bodyCopy u-marginTop--20"><span className="circleNumberGray u-marginRight--10"> 1 </span>Install the CLI on your machine by following the Velero installation instructions at: <a href="https://velero.netlify.app/docs/v1.6/basic-install/" target="_blank" rel="noopener noreferrer" className="replicated-link u-marginLeft--5">https://velero.netlify.app/docs/v1.6/basic-install/</a> </p>
                    :
                    <p className="u-fontSize--small flex-auto alignItems--center u-fontWeight--medium u-textColor--bodyCopy u-marginTop--20"><span className="circleNumberGray u-marginRight--10"> 1 </span>Install the CLI on your machine by following the <a href="https://velero.netlify.app/docs/v1.6/basic-install/" target="_blank" rel="noopener noreferrer" className="replicated-link u-marginLeft--5">Velero installation instructions</a> </p>
                  }
                    ...
                    <div className="flex flex-column">
                      ...
                      <div className="flex flexWrap--wrap" style={{ width: "500px" }}>
                        ...
                        <a href="https://github.com/vmware-tanzu/velero-plugin-for-gcp#setup" target="_blank" rel="noopener noreferrer" className="snapshotOptions">
                          ...
                          <span className="icon external-link-icon u-cursor--pointer u-marginLeft--30" /></a>
                        <a href="https://velero.netlify.app/docs/v1.6/supported-providers/" target="_blank" rel="noopener noreferrer" className="snapshotOptions">
