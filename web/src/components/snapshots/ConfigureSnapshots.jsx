      ...
      >
        <div className="Modal-body">
          ...
          {kotsadmRequiresVeleroAccess &&
            <div className="ConfigureSnapshotsTabs--wrapper flex-column u-marginTop--20 u-marginBottom--20">
              <div className="tab-items flex">
                <span
                  className={`${this.state.activeTab === VELERO_IS_NOT_INSTALLED_TAB ? "is-active" : ""} tab-item blue`}
                  onClick={() => this.toggleScheduleAction(VELERO_IS_NOT_INSTALLED_TAB)}
                >
                  I need to install Velero
                </span>
                <span
                  className={`${this.state.activeTab === VELERO_IS_INSTALLED_TAB ? "is-active" : ""} tab-item blue`}
                  onClick={() => this.toggleScheduleAction(VELERO_IS_INSTALLED_TAB)}>
          ...
          {activeTab === VELERO_IS_INSTALLED_TAB
            ? <div className="flex-column u-marginTop--12">
                ...
                <p className="u-fontSize--normal u-fontWeight--normal u-textColor--bodyCopy u-lineHeight--normal u-marginTop--20 u-marginBottom--20">
                  ...
                  Please replace {`"<velero-namespace>"`} with the actual namespace Velero is installed in, which is {`'velero'`} by default.
                </p>
              </div>
            : <div className="flex-column u-marginTop--12">
                  ...
                  <div className="flex1 flex-column u-marginBottom--30">
                    {isKurlEnabled &&
                      <p className="u-fontSize--small flex-auto alignItems--center u-fontWeight--medium u-textColor--bodyCopy u-marginTop--20">
                        ...
                        Install the CLI on your machine by following the Velero installation instructions at: <a href="https://velero.io/docs/v1.6/basic-install/" target="_blank" rel="noopener noreferrer" className="replicated-link u-marginLeft--5">https://velero.io/docs/v1.6/basic-install/</a>
                      </p>
                    }
                      ...
                      <div className="flex flex-column">
                        ...
                        <div className="flex flexWrap--wrap" style={{ width: "500px" }}>
                          ...
                          <a href="https://velero.io/docs/v1.6/supported-providers/" target="_blank" rel="noopener noreferrer" className="snapshotOptions">
                            <span style={{ width: "130px" }}>  <span className="icon cloudIcon u-cursor--pointer u-marginRight--5" />
                              Other provider
                            </span>
                            <span className="icon external-link-icon u-cursor--pointer u-marginLeft--30" />
                          </a>
                          {snapshotSettings?.isMinioDisabled
                            ...
                            : <>
                                <a
                                  className="snapshotOptions"
                                  onClick={() => openConfigureFileSystemProviderModal(FILE_SYSTEM_NFS_TYPE)}
                                >
                                  <span style={{ width: "130px" }}>
                                    <span className="icon nfsIcon u-cursor--pointer u-marginRight--5" />
                                    NFS
                                ...
                                <a
                                  className="snapshotOptions"
                                  onClick={() => openConfigureFileSystemProviderModal(FILE_SYSTEM_HOSTPATH_TYPE)}
                                >
                                  <span style={{ width: "130px" }}>
                                    <span className="icon hostpathIcon u-cursor--pointer u-marginRight--5" />
                                    Host Path
          ...
          <div className="flex justifyContent--flexStart u-marginTop--20">
            <button className="btn primary blue" onClick={toggleConfigureSnapshotsModal}>
              Ok, got it!
            </button>
          </div>
        </div>
