    ...
    return (
      <div className="flex-auto">
        <div className="flex flex-column">
          ...
          <div className="flex flex-column snapshot-form-wrapper card-bg u-padding--15" data-testid="snapshots-schedule-card">
            ...
            {this.state.activeTab === "partial" && (
              <div className="flex u-marginTop--12 u-marginBottom--15" data-testid="partial-snapshots-schedule-app-select">
                <Select
            ...
            >
              ...
              {this.state.autoEnabled && (
                <div className="flex-column flex1 u-position--relative u-marginBottom--40">
                  <div className="flex flex1">
                    <div className="flex1 u-paddingRight--5" data-testid="snapshots-schedule-interval">
                  ...
                  {hasValidCron ? (
                    <p className="cron-expression-text" data-testid="snapshots-schedule-human-readable-cron-expression">
              ...
              <div className="flex">
                ...
                {updateConfirm && (
                  <div className="u-marginLeft--10 flex alignItems--center" data-testid="snapshots-schedule-update-confirmation">
                    <Icon
        ...
        <div className="flex flex-column">
          <div className="flex flex-column snapshot-form-wrapper card-bg u-padding--15" data-testid="snapshots-retention-policy-card">
            ...
            >
              <div>
                ...
                <div className="flex u-marginBottom--20">
                  ...
                  <div className="flex1 u-paddingLeft--5" data-testid="snapshots-retention-unit">
                    <Select
                      className="replicated-select-container"
                      classNamePrefix="replicated-select"
              ...
              <div className="flex">
                ...
                {updateRetentionConfirm && (
                  <div className="u-marginLeft--10 flex alignItems--center" data-testid="snapshots-retention-policy-update-confirmation">
                    <Icon
                      icon="check-circle-filled"
                      size={16}
                      className="success-color"
