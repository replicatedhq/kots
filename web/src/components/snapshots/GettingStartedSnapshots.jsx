...
export default function GettingStartedSnapshots(props) {
  const { isVeleroInstalled, startInstanceSnapshot, isApp, appTitle, startManualSnapshot } = props;
  ...
  return (
    <div className="flex flex-column GettingStartedSnapshots--wrapper alignItems--center">
      ...
      {isApp ?
        <p className="u-marginTop--10 u-fontSize--normal u-lineHeight--more u-fontWeight--medium u-color--dustyGray">There have been no snapshots made for {appTitle || "your application"} yet. You can manually trigger snapshots or you can set up automatic snapshots to be made on a custom schedule. </p>
        :
        isVeleroInstalled ?
          ...
          :
          <p className="u-marginTop--10 u-fontSize--normal u-lineHeight--more u-fontWeight--medium u-color--dustyGray">To start backing up your data and applications, you need to have <a href="https://kots.io/kotsadm/snapshots/velero" target="_blank" rel="noopener noreferrer" className="replicated-link u-fontSize--normal">Velero</a> installed in the cluster and configured to connect with the cloud provider you want to send your backups to</p>
      }
