...
export default function GettingStartedSnapshots(props) {
  ...
  return (
    <div className="flex flex-column GettingStartedSnapshots--wrapper alignItems--center">
      ...
      <p className="u-fontSize--jumbo2 u-fontWeight--bold u-lineHeight--more u-textColor--secondary u-marginTop--20"> {isVeleroInstalled ? "No snapshots yet" : "Get started with Snapshots"} </p>
      {isApp ?
        <p className="u-marginTop--10 u-fontSize--normal u-lineHeight--more u-fontWeight--medium u-textColor--bodyCopy">There have been no snapshots made for {app?.name} yet. You can manually trigger snapshots or you can set up automatic snapshots to be made on a custom schedule. </p>
        :
        isVeleroInstalled ?
