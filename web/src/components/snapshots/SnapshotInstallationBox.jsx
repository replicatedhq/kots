  ...
  renderVeleroErrors = (snapshotSettings) => {
    if (!snapshotSettings?.isVeleroRunning && snapshotSettings?.veleroVersion) {
      return (
        ...
        <a href="https://kots.io/kotsadm/snapshots/velero-troubleshooting/" target="_blank" rel="noopener noreferrer" className="replicated-link u-marginLeft--5">Get help</a>
            </p>
          </div>
        </div>
      )
    ...
    renderResticErrors = (snapshotSettings) => {
      ...
      <a href="https://kots.io/kotsadm/snapshots/velero" target="_blank" rel="noopener noreferrer" className="replicated-link u-marginLeft--5">Get help</a>
              </p>
            </div>
          </div>
        )
