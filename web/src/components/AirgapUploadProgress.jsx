          ...
          {processingImages ? (
            <div className="flex1 flex-column alignItems--center justifyContent--center">
              <div className="flex-auto">
                <h1
                  className="u-fontSize--larger u-fontWeight--bold u-marginBottom--10 u-textAlign--center"
                  data-testid="processing-images-progress-title"
                >
                ...
                {processingImages?.map((image, i) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className="flex flex1 alignItems--center"
                        data-testid="processing-images-progress-bar"
                      >
                        <p
                      ...
                      <div className="u-marginTop--5">
                        {currentMessage ? (
                          <p
                            className="u-textAlign--center u-fontSize--small u-fontWeight--medium u-textColor--bodyCopy"
                            data-testid="processing-images-progress-message"
                          >
                            {currentMessage}
                          </p>
                        ) : (
            ...
            <div className="flex1 flex-column alignItems--center justifyContent--center">
              ...
              <div
                ...
                data-testid="airgap-upload-progress-bar"
              >
