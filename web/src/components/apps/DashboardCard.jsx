            ...
            : showOnlineUI ?
              <div className="flex1 flex-column" style={{ flexGrow: 1 }}>
                ...
                <div className="flex alignItems--center">
                  ...
                  <span className="icon settings-small-icon u-marginLeft--10 u-cursor--pointer u-marginTop--10" onClick={this.props.showAutomaticUpdatesModal} data-tip="Configure automatic update checks"></span>
