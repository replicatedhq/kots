...
export default class DashboardCard extends React.Component {
  ...
  renderLicenseCard = () => {
    const { appLicense, communityLicense } = this.props;
    const expiresAt = getLicenseExpiryDate(appLicense);


    return (
      <div>
        {communityLicense && <p className="u-fontSize--normal u-fontWeight--medium u-color--selectiveYellow u-marginBottom--15"> Community Edition </p>}
  ...
  render() {
    const { cardName, cardIcon, application, versionHistory, url, app, communityLicense } = this.props;


    return (
      <div className={`${communityLicense ? "community-dashboard-card" : "dashboard-card"} flex-column flex1 flex`}>
