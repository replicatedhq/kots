                ...
                : showOnlineUI ?
                  <div className="flex1 flex-column justifyContent--center">
                    ...
                    <div className="flex alignItems--center u-marginTop--10">
                      ...
                      <span className="icon settings-small-icon u-marginLeft--10 u-cursor--pointer" onClick={showAutomaticUpdatesModal} data-tip="Configure automatic update checks"></span>
                      <ReactTooltip effect="solid" className="replicated-tooltip" />
                    </div>
                    {updateText}
