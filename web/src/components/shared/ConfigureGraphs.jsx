...
class ConfigureGraphs extends React.Component {
  render() {
    const {
    ...
    return (
      <div className={`${toggleConfigureGraphs ? "Modal-body" : "ConfigureGraphs--wrapper"} flex-column flex1`}>
        {toggleConfigureGraphs && <h2 className="u-fontSize--largest u-fontWeight--bold u-textColor--primary u-marginBottom--10">Configure graphs</h2>}
