        ...
        <form>
          <div className="flex u-marginBottom--20">
            <div className="flex1">
              ...
              <input type="text" className="Input" disabled={app.isAirgap} placeholder="artifactory.some-big-bank.com" value={hostname || ""} autoComplete="" onChange={(e) => { this.handleFormChange("hostname", e.target.value) }} />
            </div>
          </div>
          <div className="flex u-marginBottom--20">
          ...
          <div className="flex u-marginBottom--5">
            <div className="flex1">
              ...
              <input type="text" className="Input" placeholder="namespace" disabled={app.isAirgap} value={namespace || ""} autoComplete="" onChange={(e) => { this.handleFormChange("namespace", e.target.value) }} />
            </div>
          </div>
        </form>
        {hideCta ? null :
