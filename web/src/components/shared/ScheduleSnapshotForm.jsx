...
export default class ScheduleSnapshotForm extends Component {
  ...
  render() {
    ...
    return (
      <form>
        <h2 className="u-fontSize--largest u-textColor--primary u-fontWeight--bold u-lineHeight--normal">Schedule a new snapshot</h2>
        ...
        <h2 className="u-fontSize--largest u-textColor--primary u-fontWeight--bold u-lineHeight--normal u-marginTop--20">S3 config options</h2>
        <div className="flex-column flex1 u-marginTop--20">
          ...
          <div className="flex u-marginBottom--20">
            ...
            <div className="flex1 u-paddingLeft--10">
              <p className="u-fontSize--normal u-textColor--primary u-fontWeight--bold u-lineHeight--normal u-marginBottom--10">Prefix <span className="optional-text">(optional)</span></p>
          ...
          <div className="flex u-marginBottom--20">
            <div className="flex1 u-paddingRight--10">
              <p className="u-fontSize--normal u-textColor--primary u-fontWeight--bold u-lineHeight--normal u-marginBottom--10">Access key ID <span className="optional-text">(optional)</span></p>
            ...
            <div className="flex1 u-paddingRight--10">
              <p className="u-fontSize--normal u-textColor--primary u-fontWeight--bold u-lineHeight--normal u-marginBottom--10">Access key secret <span className="optional-text">(optional)</span></p>
