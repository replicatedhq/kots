    ...
    >
      <div className="Modal-body">
        <div className="flex flex-column justifyContent--center alignItems--center">
          ...
          <p className="u-fontSize--jumbo2 u-fontWeight--bold u-lineHeight--medium u-textColor--warning u-marginTop--20"> Skipping Preflights is NOT Recommended </p>
          ...
          <div className="u-marginTop--30 flex flex-column">
            ...
            {onForceDeployClick ?
              <span className="u-fontSize--normal u-fontWeight--medium u-textDecoration--underline u-textColor--bodyCopy u-marginTop--15 u-cursor--pointer" onClick={() => onForceDeployClick(false)}>Skip Preflights and deploy</span>
              :
              <span className="u-fontSize--normal u-fontWeight--medium u-textDecoration--underline u-textColor--bodyCopy u-marginTop--15 u-cursor--pointer" onClick={() => sendPreflightsReport(appsList)}>Skip Preflights and continue</span>}
          </div>
        </div>
      </div>
    </Modal>
