        ...
        <div className="Redactors--wrapper flex1 flex-column u-width--full">
          ...
          {sortedRedactors?.length > 0 ? (
            ...
            <div className="flex-column card-bg u-padding--15">
              <p className="card-title u-paddingBottom--15">Redactors</p>
              <div className="card-item GenerateSupportBundleDetails u-padding--50 flex-column justifyContent--center alignItems--center u-textAlign--center">
