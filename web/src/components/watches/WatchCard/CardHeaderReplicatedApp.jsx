...
const CardHeaderReplicatedApp = ({ watch, expirationDate, watchIntegrations, onEditApplication, isPending }) => (
  <div className="installed-watch-header flex">
    ...
    <div className="installed-watch-integrations flex flex-column u-marginRight--30 u-paddingRight--10">
      <p className="uppercase-title">Expiration Date</p>
      <div className="flex alignItems--center">
        <p className="integration-number flex u-fontSize--large u-color--tuna u-fontWeight--bold">
          { expirationDate ? expirationDate : "Does not expire" }
        </p>
      </div>
    </div>
...
CardHeaderReplicatedApp.propTypes = {
...
export default CardHeaderReplicatedApp;
