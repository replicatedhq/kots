...
require (
	...
	github.com/replicatedhq/troubleshoot v0.13.17
...
replace (
	...
	github.com/replicatedhq/troubleshoot => github.com/croomes/troubleshoot v0.9.48-0.20211005154221-7b2a77d6b473
